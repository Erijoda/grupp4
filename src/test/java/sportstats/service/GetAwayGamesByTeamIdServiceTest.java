 ...
 * @author Davik
 */
public class GetAwayGamesByTeamIdServiceTest {
    
    @Test
    public void teamIdIsNullThrowsException() {
        try {
            new GetAwayGamesByTeamIdService(null);
    ...
    public void nonExistantTeamThrowsException() {
        ...
        try {
            new GetAwayGamesByTeamIdService(0L)
                    .init(brokerFactory)
                    .execute();
            fail("Should throw exception");
        } catch (SportstatsServiceException ex) {}
    ...
    public void existingTeamReturnsListOfGame() {
        ...
        try {
            games = new GetAwayGamesByTeamIdService(1L)
                    .init(brokerFactory)
                    .execute();
        } catch (SportstatsServiceException ex) {
    ...
    private BrokerFactory getMockedBrokerFactoryWithSettings() {
        ...
        when(gameBroker.findAwayGamesByTeamId(1L)).thenReturn(mockedGames);
